    ...
    if (userId && userId !== 'unknown' && userId !== 'web-test-user' && LINE_ACCESS_TOKEN !== 'YOUR_LINE_ACCESS_TOKEN_HERE') {
      try {
        ...
        if ((newStatus === "ชำระเงิน" || newStatus === "รอชำระเงิน") && paymentMethod === "โอนจ่าย") {
           ...
           messages.push({
             "type": "text",
             "text": "🥺 ขออภัยด้วยนะครับคุณลูกค้า ออเดอร์ " + orderId + " จำเป็นต้องขออนุญาตยกเลิกชั่วคราวครับ 🙏❤️\n\nทางร้านเกื้อกูลกันต้องขออภัยในความไม่สะดวกเป็นอย่างยิ่งเลยนะครับ หวังว่าจะได้รับโอกาสดูแลคุณลูกค้าใหม่ในโอกาสหน้านะครับ 🥰✨"
           });
        }
